...
<title>.:&nbsp;S&nbsp;I&nbsp;T&nbsp;-&nbsp;I&nbsp;C&nbsp;E&nbsp;S&nbsp;:.</title>
<link rel="SHORTCUT ICON" href="/jsp/Configuracao/IMAGENS/bbb.ico" type="image/x-icon">
...
function horizontal() {
   ...
   <li class="submenu"><a href="#">Manter Usuários</a>
      <ul class="menu">
        <li><a href="#">Adicionar Usuarios</a></li>
        <li><a href="#">Alterar Usuarios</a></li>
        <li><a href="#">Consultar Usuarios</a></li>
        <li><a href="#">Excluir Usuarios</a></li>
      </ul>
   </li>

   <li class="submenu"><a href="#">Manter Dizimos</a>
      <ul class="menu">
        <li><a href="#">Inserir registro de Dizimo por Nome</a></li>
        <li><a href="#">Inserir registro de Dizimo por ID</a></li>
   ...
   <li class="submenu"><a href="#">Manter Membros</a>
      <ul class="menu">        
        <li><a href="#">Adicionar Membro</a></li>
        <li><a href="#">Alterar membros</a></li>        
        <li><a href="#">Excluir Membro</a></li>
         <li><a href="#">Consultar membros por nome</a></li>
      </ul>
   </li>
...
</ul><%@include file="../Configuracao/relogio.html"%>
        </center>
</body>
</html>
